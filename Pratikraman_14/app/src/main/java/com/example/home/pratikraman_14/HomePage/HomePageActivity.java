...
//        }
    ...
    public ArrayList<Path> createparentListForSixthNav() {
       // Path i1 = new Path("5560","poses","",R.drawable.pose_six);
        ...
        ArrayList<Path> parentList = new ArrayList<>(Arrays.asList(i4,p1,p2,i1,p3,p4,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,i2,p6,p7,p8,p9,p10,p11,p12,p2,p13,p14,p15,i6,p11,p16,p17,p18,p19,p20,p21,i5,p22,i3,p23,a1,a2,a3,a4,a5,a6,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34));
        return parentList;
    }
    ...
    public void listOnFirstPart() {
        ...
        ArrayList<Parts> parts = new ArrayList<>(Arrays.asList(p1,p1,p1,p1,p1,p1,p1,p1,p1,p1,p1,p1));
    ...
    public void listOnThirdPart() {
        ...
        ArrayList<Parts> parts = new ArrayList<>(Arrays.asList(part,part,part,part,part,part,part,part,part,part,sthool,part,part,part,part));
    ...
    public void listOnSixthPart() {
        ...
        ArrayList<Parts> parts = new ArrayList<>(Arrays.asList(part,part,part,part,part,part,anuvrat,part,part,part,part,part,part,part,
                part,part,part,part,part,part,part,part,part,part,part,part,part,part,part,part,part,part,part,savaiya,part,part,part,part,part,part));
    ...
    public void listOnEighthPart() {
        Intent intent = new Intent(this, ExpandedNavigationDrawer.class);
        Parts p1 = new Parts(Arrays.asList(),1);
        ArrayList<Parts> parts = new ArrayList<>(Arrays.asList(p1,p1,p1,p1,p1,p1,p1,p1,p1));
    ...
    public ArrayList<Path> createparentListForThird() {
       ...
       // Path p14 = new Path("2010",this.getResources().getString(R.string.title_eng_navkar_mantra),this.getResources().getString(R.string.text_eng_navkar_mantra),R.raw.chauvistva_navkar_mantra);
        ...
        ArrayList<Path> parentList = new ArrayList<>(Arrays.asList(i2,p1,p2,p3,p4,p5,p6,i1,p7,p8,p9,p10,p11,p12,p13));
        return parentList;
    }
    ...
    public ArrayList<Path> createparentListForSixth() {
        ...
        ArrayList<Path> parentList = new ArrayList<>(Arrays.asList(i4,p1,p2,i1,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,i2,p31,p13,p14,p15,i6,p32,p16,p17,p18,p19,p20,p21,i5,p22,i3,p23,p33,p34,p24,p25,p26,p27,p28,p29,p30));
        return parentList;
    }
